...
class PiecePlacementGenerator:
    ...
    def generate_advanced_pawn_query(self, board: chess.Board) -> Dict:
        ...
        perception = (
            f"[Perception] Attending to the 64 <board_state> visual tokens in parallel "
...
if __name__ == "__main__":
    ...
    generator = PiecePlacementGenerator(output_file="phase1_piece_placement.jsonl")
    generator.generate_dataset(sample_fens * 25)   # 100 samples
